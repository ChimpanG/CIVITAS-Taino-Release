...
-----------------------------------------------	
	...
	("LOC_LEADER_CVS_ANACAONA_NAME", "Anacaona"	),
	
-----------------------------------------------
-- UA
-----------------------------------------------	

	("LOC_TRAIT_LEADER_CVS_ANACAONA_UA_NAME",  "Golden Flower"	),
	("LOC_TRAIT_LEADER_CVS_ANACAONA_UA_DESCRIPTION",
...
-----------------------------------------------
	...
	("LOC_IMPROVEMENT_CVS_ANACAONA_UI_NAME",	"Conuco"	),
	("LOC_IMPROVEMENT_CVS_ANACAONA_UI_DESCRIPTION",		  
	"Unlocks the Builder ability to construct a Conuco, unique to the Taino. Provides +1 [ICON_Culture] Culture and doubles the base terrain yield of the plot when built adjacent to a resource. May not be built on hills."),

	("LOC_PEDIA_IMPROVEMENTS_PAGE_IMPROVEMENT_CVS_ANACAONA_UI_CHAPTER_HISTORY_PARA_1",	
	...
	("LOC_PEDIA_IMPROVEMENTS_PAGE_IMPROVEMENT_CVS_ANACAONA_UI_CHAPTER_HISTORY_PARA_2",	
	...
	("LOC_PEDIA_IMPROVEMENTS_PAGE_IMPROVEMENT_CVS_ANACAONA_UI_CHAPTER_HISTORY_PARA_3",	
...
-----------------------------------------------	
	...
	("LOC_AGENDA_CVS_ANACAONA_NAME",	"Datiao"	),
	("LOC_AGENDA_CVS_ANACAONA_DESCRIPTION", 	"Tries to maintain peace and respects civilizations that do the same. Greatly dislikes civilizations that attack City-States."	),
	("LOC_DIPLO_KUDO_LEADER_CVS_ANACAONA_REASON_ANY",	
	"(You are keeping the peace.)"	),
	("LOC_DIPLO_MODIFIER_CVS_ANACAONA_HAPPY",		
	"Anacaona is pleased that you are keeping the peace."	),
	("LOC_DIPLO_WARNING_LEADER_CVS_ANACAONA_REASON_ANY",		  
	"(You have been at war on her home continent or attacked a City-State.)"	),
	("LOC_DIPLO_MODIFIER_CVS_ANACAONA_UNHAPPY",			 
...
-- DOM
	("LOC_LOADING_INFO_LEADER_CVS_ANACAONA",  	
...
-- FIRST MEET
	-- First AI Line
	("LOC_DIPLO_FIRST_MEET_LEADER_CVS_ANACAONA_ANY",		
	...
	("LOC_DIPLO_FIRST_MEET_VISIT_RECIPIENT_LEADER_CVS_ANACAONA_ANY",		
	...
	("LOC_DIPLO_FIRST_MEET_NEAR_INITIATOR_POSITIVE_LEADER_CVS_ANACAONA_ANY",		
	"I would be honored. Thank you."	),
	
	-- AI invitation to exchange Capital Information
	("LOC_DIPLO_FIRST_MEET_NO_MANS_INFO_EXCHANGE_LEADER_CVS_ANACAONA_ANY",		
	"Let us enjoy each other's hospitality and exchange information about our capitals. What do you say?"	),

-- GREETINGS	
	("LOC_DIPLO_GREETING_LEADER_CVS_ANACAONA_ANY",		
	"Hello, friend. What can I do for you?"	),
	
-- DELEGATION
	-- AI Accepts
	("LOC_DIPLO_ACCEPT_DELEGATION_FROM_HUMAN_LEADER_CVS_ANACAONA_ANY",		
	"It would be my pleasure to welcome your delegates. I will ensure that their stay with us is welcomed and remembered."	),
	
	-- AI Rejects
	("LOC_DIPLO_REJECT_DELEGATION_FROM_HUMAN_LEADER_CVS_ANACAONA_ANY",		
	"No, I'm sorry. Let's get to know each other better first."	),
	
	-- AI Requests
	("LOC_DIPLO_DELEGATION_FROM_AI_LEADER_CVS_ANACAONA_ANY",		
...
-- KUDOS & WARNINGS
	...
	("LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_LEADER_CVS_ANACAONA_ANY",		
...
-- DEFEAT
	...
	("LOC_DIPLO_DEFEAT_FROM_HUMAN_LEADER_CVS_ANACAONA_ANY",		
	"Regrettably, the gods have not answered my call. You may take many lives like the hurricane, but be warned, sometimes even a butterfly can change the way the wind blows. You'll meet your comeuppance."	),	
...
--------------------------------------------------------------------
	...
	("LOC_PEDIA_LEADERS_PAGE_CVS_ANACAONA_QUOTE",		
	"Pursue not what catches one's eye, but what captures one's heart."  ),
	
	("LOC_PEDIA_LEADERS_PAGE_CVS_ANACAONA_TITLE",		
	"Anacaona"),
	
	("LOC_PEDIA_LEADERS_PAGE_CVS_ANACAONA_SUBTITLE",		
	"Cacica"),
	
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ANACAONA_CHAPTER_CAPSULE_BODY",		
	"Versatile in victory, diplomacy with City-States is the key to Taino's success. Under Anacaona, Conucos will increase the potential of surrounding terrain and reap the rewards of City-State diplomacy with an abundance of [ICON_Faith] Faith in which to spend on [ICON_GreatPerson] Great People."),
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ANACAONA_CHAPTER_DETAILED_BODY",		
	"The initial push for Taino is to take advantage of their quick Macana warriors to meet as many city-states as possible. Using the Batéy and its unique Areyto Ceremony project will allow them to produce [ICON_Envoy] Envoys to Suzerain as many City-States as possible in order to reap the rewards of doubled type-bonuses. With Anacaona leading them, Taino have a unique opportunity to double-up on terrain yields with their unique Conuco improvement, allowing her to grow her cities faster. With the ability to buy Great People with 25% less Faith, Anacaona will find such versatility suitable for any victory condition."	),

	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ANACAONA_CHAPTER_HISTORY_PARA_1",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ANACAONA_CHAPTER_HISTORY_PARA_2",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ANACAONA_CHAPTER_HISTORY_PARA_3",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ANACAONA_CHAPTER_HISTORY_PARA_4",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ANACAONA_CHAPTER_HISTORY_PARA_5",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ANACAONA_CHAPTER_HISTORY_PARA_6",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ANACAONA_CHAPTER_HISTORY_PARA_7",		
