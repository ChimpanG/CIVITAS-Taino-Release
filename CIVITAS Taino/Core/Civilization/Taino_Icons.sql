...
VALUES  ('ICON_ATLAS_CVS_TAINO_ICON',			256,	 	1,				1,				'CIVILIZATION_CVS_TAINO_ICON_256.dds'			),
		...
		('ICON_ATLAS_CVS_TAINO_ICON',			45,	 		1,				1,				'LEADER_CVS_ANACAONA_ICON_45.dds'				),
...
VALUES 	('ICON_ATLAS_CVS_TAINO_CIVITAS',		6,			22,			1,				1,				'CVS_TAINO_CIVITAS.dds'					),
		('ICON_ATLAS_CVS_TAINO',				6,			22,			1,				1,				'CIVILIZATION_CVS_TAINO_FONTICON.dds'	);
...
VALUES  ('ICON_CIVILIZATION_CVS_TAINO',							'ICON_ATLAS_CVS_TAINO_ICON',				0			),
		...
		('CVS_Taino',											'ICON_ATLAS_CVS_TAINO',						0			), -- FontIcon
		('CVS_Taino_Civitas',									'ICON_ATLAS_CVS_TAINO_CIVITAS',				0			); -- FontIcon
